...
public class RegexSearchByAuthorResult extends JDialog {
	 ...
	 * Create the dialog.
	 */
	public RegexSearchByAuthorResult(String author) {
		setTitle("查找结果");
			...
			buttonPane.setLayout(null);
			{
				...
				yesButton.addActionListener(new ActionListener() {
					public void actionPerformed(ActionEvent e) {
						RegexSearchByAuthorResult.this.dispose();
					}
				});
		...
		BookList booklist = new Operation().regexSearchByAuthor(book);
