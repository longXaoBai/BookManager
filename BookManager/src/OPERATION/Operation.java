...
public class Operation {
	...
	public boolean deleteByBookname(Book book){
		try {
			Connection dbConn = DBConnection.getConnection();
	...
	public boolean deleteByAuthor(Book book){
		try {
			Connection dbConn = DBConnection.getConnection();
			String sql = "delete from BookList where author = ?";
			PreparedStatement pstmt = dbConn.prepareStatement(sql);
	...
	public BookList regexSearch(String str){
		BookList booklist = new BookList();
		try {
			Connection dbConn = DBConnection.getConnection();
			String sql = "select * from BookList where id regexp ? or bookname regexp ? or author regexp ?";
			PreparedStatement pstmt = dbConn.prepareStatement(sql);
	...
	public BookList regexSearchById(Book book){
		BookList booklist = new BookList();
		try {
			Connection dbConn = DBConnection.getConnection();
	...
	public BookList regexSearchByBookname(Book book){
		BookList booklist = new BookList();
		try {
			Connection dbConn = DBConnection.getConnection();
	...
	public BookList regexSearchByAuthor(Book book){
		BookList booklist = new BookList();
		try {
			Connection dbConn = DBConnection.getConnection();
